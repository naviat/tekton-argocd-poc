...
class ProductsRestControllerHttpTest {
    ...
    void givenAValidLabelAndProductsAssociatedToThatLabel_whenProductsListIsRequested_thenProductsAssociatedAreRetrieved()
        ...
        final List<ProductDTO> productsRetrieved = mapper.readValue(
                result.getResponse().getContentAsString(StandardCharsets.UTF_8), new TypeReference<List<ProductDTO>>() {
                });
    ...
    void givenSomeValidLabelsAndProductsAssociatedToThatLabel_whenProductsListIsRequested_thenProductsAssociatedAreRetrieved()
        ...
        ObjectMapper mapper = new ObjectMapper();
        final List<ProductDTO> productsRetrieved = mapper.readValue(result.getResponse().getContentAsString(),
